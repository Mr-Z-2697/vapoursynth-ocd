...
VS_EXTERNAL_API(void) VapourSynthPluginInit2(VSPlugin *plugin, const VSPLUGINAPI *vspapi) {
    ...
    vspapi->registerFunction("gb", "clip:vnode;sigmax:float:opt;sigmay:float:opt;sizex:int:opt;sizey:int:opt;bordertype:int:opt;", "clip:vnode;", gblurCreate, NULL, plugin);
}
